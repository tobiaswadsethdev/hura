...
pub const TOOLCHAINS: [Toolchain; 3] = [
    Toolchain {
        ...
        layer: include_str!("../../../images/hura-base/toolchains/dotnet.dockerfile"),
        registries: &[Registry {
            host: "api.nuget.org",
            port: 443,
    ...
    Toolchain {
        ...
        layer: include_str!("../../../images/hura-base/toolchains/node.dockerfile"),
        registries: &[Registry {
    ...
    Toolchain {
        ...
        layer: include_str!("../../../images/hura-base/toolchains/rust.dockerfile"),
        registries: &[
...
pub const MANIFEST_PATH: &str = "/usr/local/share/hura/toolchains";
...
pub fn dockerfile(chains: &[&'static Toolchain]) -> String {
    ...
    out.push_str(
        "#\n# Generated by `hura image build --toolchain`; see crates/hura/src/toolchain.rs.\n",
    );
...
mod tests {
    ...
    fn the_generated_dockerfile_layers_onto_the_base_and_drops_privileges() {
        ...
        let dir = df.find("mkdir -p /usr/local/share/hura").expect("mkdir");
    ...
    /// Every layer has to record itself, or `hura doctor` reads an image that
    ...
    fn a_checkout_is_read_for_what_it_is_written_in() {
        let root = std::env::temp_dir().join(format!("hura-detect-{}", std::process::id()));
