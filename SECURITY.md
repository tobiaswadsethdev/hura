...
`hura` exists to run agents that will happily do what they are told, inside
...
[Security tab](https://github.com/tobiaswadsethdev/hura/security/advisories/new).
...
Anything where `hura` itself is the weak link:

* policy generated by `hura` that is weaker than what its template describes, or
